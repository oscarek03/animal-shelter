<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        try {
            ...
            $deleteSql = "DELETE FROM pracownik_zwierzeta WHERE zwierze_id = :animalId";
            $deleteStmt = oci_parse($conn, $deleteSql);
            oci_bind_by_name($deleteStmt, ':animalId', $animalId);
            oci_execute($deleteStmt);

            // Dodaj nowe przypisania
            $insertSql = "INSERT INTO pracownik_zwierzeta (zwierze_id, pracownik_id) VALUES (:animalId, :workerId)";
