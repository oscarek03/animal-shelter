...
try {
    ...
    if ($result) {
        echo json_encode(['success' => true, 'message' => 'Darowizna została pomyślnie usunięta.']);
    } else {
        $e = oci_error($stid);
        echo json_encode(['success' => false, 'message' => 'Błąd podczas usuwania darowizny: ' . $e['message']]);
    }
} catch (Exception $e) {
