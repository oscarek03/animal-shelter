...
$sql =
    "BEGIN dodaj_adopcje(:id_zwierzecia, :id_pracownika, :id_adresu, TO_DATE(:data_adopcji, 'YYYY-MM-DD'), :imie, :nazwisko, :telefon); END;";
...
if ($result) {
    ...
    $update_sql =
        "UPDATE ZWIERZETA SET STATUS = 'Adoptowany' WHERE ID = :id_zwierzecia";
