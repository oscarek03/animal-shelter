...
try {
    ...
    $sql = "BEGIN edytuj_darowizne(:id, :darczynca_id, :kwota, TO_DATE(:data, 'YYYY-MM-DD')); END;";
    ...
    if ($result) {
        echo json_encode(['success' => true, 'message' => 'Darowizna została pomyślnie zaktualizowana.']);
    } else {
        $e = oci_error($stid);
        echo json_encode(['success' => false, 'message' => 'Błąd podczas edycji darowizny: ' . $e['message']]);
    }
} catch (Exception $e) {
